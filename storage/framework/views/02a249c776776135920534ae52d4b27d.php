          ...
          <li class="nav-item dropdown">
            ...
            <a class="nav-link" data-toggle="dropdown" >
              ...
              <div class="user-panel d-flex">
                <div class="image">
                  <img src="<?php echo e(asset('dist/img/user2-160x160.jpg')); ?>" alt="Example Image" style="border-radius: 50px;">
                </div>
              </div>
            </a>
...
<?php /**PATH C:\xampp\htdocs\epvs-app2\resources\views/layouts/admin-navigation.blade.php ENDPATH**/ ?>