...
<body>
    ...
    <section  class="image-bg" style=" background-image: url('./assets/landing/landingpage.png');"> 
        <main class="container-fluid">
            <div class="col-md-6">
              <a href="<?php echo e(url('/login')); ?>"   target="_blank" class=" d-flex align-items-center mb-3 mb-md-0 me-md-auto text-decoration-none">
                <img class="logo-welcome" src="<?php echo e(asset('assets/landing/LVCC.png')); ?>" alt="lvcc Logo" style=" width:908px ; height:169px;">
              </a>
            </div>
            <div class="p-md-5 mb-4 rounded bg-white">
              <img src="<?php echo e(asset('assets/landing/bdo2.png')); ?>" alt="bdo" style=" width:100% ; height: 100%;">
              <div class="wrapper">
                <div class="box row ">
                  <div class="col-11">
            ...
            <button id="next-button" class="btn btn-lg btn-secondary pl-5 pr-5" onclick="window.location.href='<?php echo e(url('/privacy-form')); ?>'" data-toggle="tab" disabled>
            ...
            <div class=" p-md-5 mb-4 rounded bg-white ">
                ...
                <div class="modal fade" id="FromDesktopBDO" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <img src="<?php echo e(asset('assets/sample-receipts/Gcash-email.png')); ?>" alt="fromdesktopbdo" width="100%" height="100%">
                        </div>
                ...
                <div class="modal fade" id="DepositSlipfromBDOBranch" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <img src="<?php echo e(asset('assets/sample-receipts/Gcash-mobile-save.jpg')); ?>" alt="DepositSlipfromBDOBranch" width="100%" height="100%">
                        </div>
                        <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                        </div>
                ...
                <div class="modal fade" id="MobileBankingBDO" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <img src="<?php echo e(asset('assets/sample-receipts/Gcash-mobile-ss.jpg')); ?>" alt="MobileBankingBDO" width="100%" height="100%">
                        </div>
                        <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                        </div>
                ...
                <div class="modal fade" id="TransactionHistoryfromGcashApp" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <img src="<?php echo e(asset('assets/sample-receipts/metrobank.jpg')); ?>" alt="TransactionHistoryfromGcashApp" width="100%" height="100%">
                        </div>
                        <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                        </div>
                ...
                <div class="modal fade" id="EmailfromGcash" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <img src="<?php echo e(asset('assets/sample-receipts/unionbank.jpg')); ?>" alt="EmailfromGcash" width="100%" height="100%">
                        </div>
                        <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                        </div>
                ...
                <div class="modal fade" id="InboxofGcashApp" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div class="modal-content"> 
                        ...
                        <div class="modal-body">
                            <img src="<?php echo e(asset('assets/sample-receipts/PNB-debit.jpg')); ?>" alt="InboxofGcashApp" width="100%" height="100%">
                        </div>
                        <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                        </div>
                ...
                <div class="modal fade" id="TextMessagefromGcash" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <img src="<?php echo e(asset('assets/sample-receipts/send-money-instapay.jpg')); ?>" alt="TextMessagefromGcash" width="100%" height="100%">
                        </div>
                        <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                        </div>
                ...
                <div class="modal fade" id="Metrobank" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <img src="<?php echo e(asset('assets/sample-receipts/pesonet-gateway.jpg')); ?>" alt="Metrobank" width="100%" height="100%">
                        </div>
                        <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                        </div>
...
</html><?php /**PATH C:\xampp\htdocs\epvs-app2\resources\views/welcome.blade.php ENDPATH**/ ?>