                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="card align_right">
                                        <img src="<?php echo e($details['receipt']); ?>" alt="Image Description" title="Image Title" style="border-radius: 10px; width: 50%;"  class="image-class align_right">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                        ...
                                        <div class="card align-left">
                                            <div class="card-body">
                                                        ...
                                                        <div class="form-group">
                                                            <input type="text" value="<?php echo e($LoggedUserProfile['profile_key'] ?? $firstProfileKey); ?>" name="uploadform_key" hidden>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="amount" placeholder="Edit here..." name="amount" value="<?php echo e($details['ocr_result']['amount']); ?>">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="reference">Reference Number: <span class="asterisk">*</span></label>
                                                            <input type="text" class="form-control" id="reference" name="reference" value="<?php echo e($details['ocr_result']['referenceNumber']); ?>" placeholder="Edit here...">
                                                        </div>
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-6">
                                                                <input type="date" class="form-control" placeholder="Edit here..." value="<?php echo e($details['ocr_result']['date']); ?>" name="date">
                                                            </div>
                                                            <div class="col-sm-6">
                                                                <input type="time" class="form-control" placeholder="Edit here..." value="<?php echo e($details['ocr_result']['time']); ?>" name="time">
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <a href="<?php echo e(url('/upload-form')); ?>" class="btn btn-primary"><i class="fas fa-arrow-left"></i> BACK</a>
                                        </div>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\epvs-app2\resources\views/form/verify-form.blade.php ENDPATH**/ ?>