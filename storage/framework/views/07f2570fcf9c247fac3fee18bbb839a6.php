    ...
    <div class="row main-content">
        <form method="post" action="/upload-form" enctype="multipart/form-data">
            ...
            <div class="col-md-5 col-sm-12 my-3 mx-auto my-auto px-5">
                <div class="my-2">
                    <input type="text" value="<?php echo e($LoggedUserProfile['profile_key']); ?>" name="uploadform_key" hidden>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\epvs-app2\resources\views/form/upload-form-2.blade.php ENDPATH**/ ?>