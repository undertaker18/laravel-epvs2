                            ...
                            <div class="card-header">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="privacy-content">
                                            <p><b>PRIVACY NOTICE:</b> Dear student(s)/parent(s)/guardian(s), we would 
                                                ...
                                                <input type="text" name="privacy_key" value="<?php echo e($privacy->privacy_key); ?>" hidden>
                                    ...
                                    <div class="col-md-12">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <button class="btn btn-lg btn-primary pl-5 pr-5" onclick="window.location.href='<?php echo e(url('/')); ?>'" data-toggle="tab">
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\epvs-app2\resources\views/form/privacy-notice-form.blade.php ENDPATH**/ ?>