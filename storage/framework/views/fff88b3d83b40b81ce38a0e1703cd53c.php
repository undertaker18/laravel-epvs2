       ...
       <div class="col-lg-4 mb-5 mb-lg-0 cards" style="z-index: 10">
           ...
           <div class="card-body px-4 py-5 px-md-5 b-0">
               <div class=" d-flex justify-content-center">
                   <img class="" src="<?php echo e(asset('assets/data-privacy/lvcclogo.png')); ?>" alt="lvcc-logo" style="width: 150px; height: 150px;">  
               </div>
               <div class=" d-flex justify-content-center">
...
<?php endif; ?>
               ...
               <!-- Submit button -->
               <?php if (isset($component)) { $__componentOriginal71c6471fa76ce19017edc287b6f4508c = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.primary-button','data' => ['class' => 'btn btn-dark  mb-4 w-full button-color justify-content-center']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'btn btn-dark  mb-4 w-full button-color justify-content-center']); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\epvs-app2\resources\views/auth/login.blade.php ENDPATH**/ ?>