                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-8">
                                <!-- small box -->
                                <a href="<?php echo e(url('/receipt-valid')); ?>">
                                    <div class="small-box"
                            ...
                            <div class="col-lg-4 col-6">
                                <!-- small box -->
                                <a href="<?php echo e(url('/receipt-pending')); ?>">
                                    <div class="small-box"
                            ...
                            <div class="col-lg-4 col-6">
                                <!-- small box -->
                                <a href="<?php echo e(url('/receipt-reject')); ?>">
                                    <div class="small-box"
                            ...
                            <table class="table table-striped" id="example"
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><a href="<?php echo e(url('/receipt-image')); ?>">View</a></td>
                                    </tr>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\epvs-app2\resources\views/receipt-valid.blade.php ENDPATH**/ ?>