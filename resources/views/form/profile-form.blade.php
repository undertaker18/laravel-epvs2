                ...
                <div class="active tab-pane" id="profile">
                    <div class=" main-content">
                        <div class="card">
                            ...
                            <form action="{{ route('post-profile-form', $formEpv->id) }}" method="POST">
                                @csrf
                                    ...
                                    <div class="card-2 m-3 bg-form ">
                                        ...
                                        <div id="formsContainer" class="card-body p-3">
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="student_type" class="form-label">Student
                                                            Type:</label>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="grade_year[]" class="form-control" autofocus required>
                                                            <option value="" selected disabled>Choose...</option>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="selectInput5" class="form-control"
                                                            name="scholarshipStatus[]" autofocus required>
                                                            <option value="" selected disabled>Choose...</option>
                                ...
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="button-container flexed start">
                                            ...
                                            <a href="{{ route('edit-privacy-form', ['formEpvId' => $formEpv->id]) }}"
                                    ...
                                    <div class="col-md-5">
                                        <div class="button-container flexed end">
                                            <button id="nextBtn" class="btn  btn-success add" type="submit" name="submit"
                                                >
                            ...
                            {{-- <script>
                                ...
                                const div1 = document.querySelector('#studentInfo .card-2:nth-child(1)');
                                const div2 = document.querySelector('#studentInfo .card-2:nth-child(2)');
                                const div3 = document.querySelector('#studentInfo .card-2:nth-child(3)');
                                let clickCount = 0;
