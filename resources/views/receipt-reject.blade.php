<x-admin-layout>
        ...
        <div class="content-wrapper" style="background-color: #EAF1F8;">
            ...
            <div style="text-align: right;  ">
                <button id="myButton" class="btn btn-default mr-4 mb-3" onclick="alert('Button clicked!')" style="background-color: #D74747; color: #ffffff; width: 170px;"><i class="fas fa-envelope"></i>&nbsp;&nbsp;&nbsp;SEND TO EMAIL</button>
            </div>
            <!-- data tables -->
                        ...
                        <table id="example1" class="table table-bordered  table-hover">
                            <thead>
                                <tr style="color: #000000;">
                                    <th><input type="checkbox" id="my-checkbox" name="my-checkbox" class="checkbox"></th>
                                    <th>Fullname</th>
                                    <th>Grade/Course</th>
