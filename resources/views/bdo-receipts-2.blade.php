    ...
    <div class="content-wrapper" style="background-color: #EAF1F8;">
        ...
        <section style="width:98%; margin-left:15px; margin-right: 80px; border-radius: 8px;">
            ...
            <form action="/bdo-xero-receipts" method="GET">
                <input type="date" id="start" name="dateStart" value="{{$params['dateFrom']}}" required>

                <input type="date" id="start" name="dateEnd" value="{{$params['dateTo']}}" required>

                <button type="submit" class="btn btn-primary " style="background-color:#008000; margin-left: 10px;">Search</button>
            </form>
            </div>
