...
class FormController extends Controller
{
    ...
    {
        $privacy_noticeList = $request->input('privacy_notice');
        ...
        foreach ($fullnameList as $index => $fullname) {
            ...
            $profile->privacy_notice = $privacy_notice[$index]; // Assign the same profile_key to each profile
        ...
        return redirect( route('edit-privacy-form', $profile->id));
    }
