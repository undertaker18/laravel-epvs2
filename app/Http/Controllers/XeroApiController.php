...
class XeroApiController extends Controller
{
    ...
    // const CLIENT_ID = '65E0B44A363548B5AEB2EC886C8E7CFB';
    // const CLIENT_SECRET = 'mffcpfwfDsacHswX1hOilmpjPLQL0TLZ6usXJt7rRCF8PdcL';
    // const REDIRECT_URL = 'http://localhost/index';
    // const TENANT_ID = 'd510baa5-e646-44f8-acab-4d6fcac563d3';
    // const STATE = 123;
    // const SCOPE = 'offline_access accounting.transactions openid profile email accounting.contacts accounting.settings';

    public function __construct()
    {
        $this->clientId = '0269B3AFB0BB40BB8D63883304C3F9D2';
        $this->clientSecret = 'HzQisWkKOKuKkOCl_gJ2Ft4dcU7NisJ5s2gxxXp9oAjOeStP';
        $this->scope = 'offline_access accounting.transactions openid profile email accounting.contacts accounting.settings';
        $this->state = '123';
        $this->tenantId = '9b095c99-9f1d-4703-ab1e-27f968adebb5';
        // $this->authRedirectUri = 'http://localhost:8000/api/v1/xero/token';
        // $this->tokenRedirectUri = 'http://localhost:8000/api/v1/xero/token';
    ...
    {
        // todo: use app
        // $clientId = '65E0B44A363548B5AEB2EC886C8E7CFB';
        // $clientSecret = 'mffcpfwfDsacHswX1hOilmpjPLQL0TLZ6usXJt7rRCF8PdcL';
    ...
    public function getToken(Request $request)
    {
        ...
        curl_setopt_array($curl, array(
            ...
            CURLOPT_HTTPHEADER => array(
                ...
                'Authorization: Basic MDI2OUIzQUZCMEJCNDBCQjhENjM4ODMzMDRDM0Y5RDI6SHpRaXNXa0tPS3VLa09DbF9nSjJGdDRkY1U3TmlzSjVzMmd4eFhwOW9Bak9lU3RQ',
            ),
        ));
    ...
    public function postInvoice($params = [])
    {
        ...
        // $dueDate = Carbon::now()->addDay('1')->format('Y-m-d');;
        // $reference = 'Xero - University Payment System';
